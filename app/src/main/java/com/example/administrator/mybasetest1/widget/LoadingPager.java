package com.example.administrator.mybasetest1.widget;
...
//        });
    ...
    private View createLoadingView() {
        return View.inflate((Context) AppConfig.getConfiguration(ConfigKey.APPLICATION_CONTEXT), R.layout.loading_page, null);
    }

    private View createEmptyView() {
        return View.inflate((Context) AppConfig.getConfiguration(ConfigKey.APPLICATION_CONTEXT), R.layout.loading_page_empty, null);
    }

    private View createErrorView() {
        View view= View.inflate((Context) AppConfig.getConfiguration(ConfigKey.APPLICATION_CONTEXT), R.layout.loading_error_page, null);
